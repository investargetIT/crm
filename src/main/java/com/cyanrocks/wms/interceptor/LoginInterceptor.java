package com.cyanrocks.wms.interceptor;

import com.cyanrocks.wms.utils.http.HttpClientService;
...
public class LoginInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        // 在请求到达控制器之前进行处理
//        String url = "https://user.peidigroup.cn/user/user-check?token=" + request.getHeader("Authorization");
